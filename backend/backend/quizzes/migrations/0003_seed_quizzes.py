...
def seed_quizzes(apps, schema_editor):
    ...
    if not alice:
        alice = User.objects.create_user(username='alice', password='alice123')
    if not bob:
        bob = User.objects.create_user(username='bob', password='bob123')
    if not charlie:
        charlie = User.objects.create_user(username='charlie', password='charlie123')
    ...
    dataset = [
        ...
        },
        {
            ...
            "name": "Math Sprint",
            "author": alice,
            "description": "Quick math questions for beginners",
            "icon": "➕",
            "tags": ["math", "numbers", "beginner"],
            "questions": [
                {
                    "id": "add-2",
                    "text": "2 + 3 = ?",
        ...
        },
        {
            ...
            "author": bob,
            "description": "Explore fascinating facts about our solar system",
            "icon": "🪐",
            "tags": ["science", "space"],
            "questions": [
                {
        ...
        },
        {
            ...
            "author": charlie,
            "description": "Famous artists and their masterpieces",
            "icon": "🎨",
            "tags": ["art", "history"],
            "questions": [
                {
                ...
                },
                {
                    ...
                    "options": ["Giverny", "Arles", "Saint-Rémy", "Paris"],
                    "correctIndex": 2,
                },
            ],
        },
