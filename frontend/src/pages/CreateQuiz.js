...
function CreateQuiz() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.questions.length !== questionCount) {
        ...
        <div>
          <div className="screen-header">
            <h1 className="page-title">
              Add Questions <span className="question-counter">({formData.questions.length}/{questionCount})</span>
            </h1>
            {formData.questions.length === questionCount && (
              <button
                type="button"
